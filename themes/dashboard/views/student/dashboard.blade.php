    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="alert alert-warning" role="alert">
                <h4 class="alert-heading">Silahkan kerjakan dengan hati-hati!!</h4>
                <p>Kerjakan dengan tenang dan tidak terburu-buru</p>
                <hr>
            </div>
        </div>
                    ...
                    @foreach ($portal_exams as $key => $exam)
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="small-box <?php echo $cls; ?>">
                                ...
                                @if (strtotime(date('Y-m-d')) <= strtotime($exam['exam_date']))
                                    <a data-id="{{ $exam['id'] }}" class="apply_exam small-box-footer">Apply<i
